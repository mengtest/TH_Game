...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public UnityEngine.GameObject __Gen_Delegate_Imp7(UnityEngine.GameObject p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.GameObject __Gen_Delegate_Imp8()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(Scene.SettingScene.UnityAction1))
			{
			    return new Scene.SettingScene.UnityAction1(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(Scene.SettingScene.UnityAction2))
			{
		    ...
		    if (type == typeof(Util.pool.GameObjectPool.Operator1))
			{
			    return new Util.pool.GameObjectPool.Operator1(__Gen_Delegate_Imp7);
			}
		
		    if (type == typeof(Util.pool.GameObjectPool.Operator))
			{
			    return new Util.pool.GameObjectPool.Operator(__Gen_Delegate_Imp8);
			}
