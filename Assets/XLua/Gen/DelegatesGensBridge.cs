...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new Util.Listener.Callback(__Gen_Delegate_Imp0);
			}
			...
			{
			    return new Scene.SettingScene.UnityAction2(__Gen_Delegate_Imp10);
			}
		
		    if (type == typeof(Scene.SettingScene.UnityAction1))
			{
			    return new Scene.SettingScene.UnityAction1(__Gen_Delegate_Imp11);
			}
			...
			{
			    return new Util.Listener.Predicate(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(Util.Listener.AsyncCall))
			{
			    return new Util.Listener.AsyncCall(__Gen_Delegate_Imp16);
			}
