...
namespace XLua.CSObjectWrap
{
    ...
    public class UtilpoolIPoolWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Util.pool.IPool);
        ...
        {
            return LuaAPI.luaL_error(L, "Util.pool.IPool does not have a constructor!");
        }
        ...
        static int _m_GetItem(RealStatePtr L)
        {
		    try {
                ...
                Util.pool.IPool gen_to_be_invoked = (Util.pool.IPool)translator.FastGetCSObj(L, 1);
