...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(Pool.IPool), PoolIPoolWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Pool.ObjectPool), PoolObjectPoolWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Pool.PoolManager), PoolPoolManagerWrap.__Register);
