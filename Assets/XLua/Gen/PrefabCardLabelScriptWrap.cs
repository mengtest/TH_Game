...
namespace XLua.CSObjectWrap
{
    ...
    public class PrefabCardLabelScriptWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Prefab.CardLabelScript);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Prefab.CardLabelScript gen_ret = new Prefab.CardLabelScript();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Prefab.CardLabelScript constructor!");
        ...
        static int _m_OnPointerClick(RealStatePtr L)
        {
		    try {
                ...
                Prefab.CardLabelScript gen_to_be_invoked = (Prefab.CardLabelScript)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_icon(RealStatePtr L)
        {
		    try {
                ...
                Prefab.CardLabelScript gen_to_be_invoked = (Prefab.CardLabelScript)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.icon = (UnityEngine.UI.Image)translator.GetObject(L, 2, typeof(UnityEngine.UI.Image));
