...
namespace XLua.CSObjectWrap
{
    ...
    public class GlobalNavigatorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Global.Navigator);
        ...
        {
            return LuaAPI.luaL_error(L, "Global.Navigator does not have a constructor!");
        }
        ...
        static int _m_NavigateTo_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    Global.Navigator.NavigateTo( _id, _loading );
                ...
                if(gen_param_count == 1&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)) 
                {
                    ...
                    Global.Navigator.NavigateTo( _id );
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    Global.Navigator.NavigateTo( _name, _loading );
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    Global.Navigator.NavigateTo( _name );
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    Global.Navigator.NavigateTo( _name, _id );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Global.Navigator.NavigateTo!");
