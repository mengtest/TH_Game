...
namespace XLua.CSObjectWrap
{
    ...
    public class GlobalWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetCanvas", _m_GetCanvas_xlua_st_);
        ...
        static int _m_GetCurCanvas_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.GameObject>(L, 1)) 
                {
                    UnityEngine.GameObject _go = (UnityEngine.GameObject)translator.GetObject(L, 1, typeof(UnityEngine.GameObject));
                        ...
                        UnityEngine.Canvas gen_ret = Global.GetCurCanvas( _go );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.Component>(L, 1)) 
                {
                    UnityEngine.Component _comp = (UnityEngine.Component)translator.GetObject(L, 1, typeof(UnityEngine.Component));
                        ...
                        UnityEngine.Canvas gen_ret = Global.GetCurCanvas( _comp );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Global.GetCurCanvas!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetCanvas_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        UnityEngine.Canvas[] gen_ret = Global.GetCanvas(  );
                        translator.Push(L, gen_ret);
